			...
			<div class="container">
				<div class="row">
					<div class="col-lg-12 d-flex justify-content-center">
						<ul id="portfolio-flters">
							<li data-filter="*" class="filter-active">All</li>
							<li data-filter=".filter-app">음악</li>
							<li data-filter=".filter-card">공포/스릴러</li>
							<li data-filter=".filter-web">다큐멘터리</li>
							<li data-filter=".filter-web">판타지</li>
							<li data-filter=".filter-web">로맨스</li>
							<li data-filter=".filter-web">액션</li>
						</ul>
					</div>
				</div>
				...
				<div class="row portfolio-container">
					<c:forEach var="post" items="${boardlist}">
						<a href="detail?no=${post.no}">
						<div class="col-lg-4 col-md-6 portfolio-item filter-app">
							<div class="portfolio-wrap">
								<c:if test="${board.imageUrl !=null}">
									<img src="/upload/${board.imageUrl}"
										class="img-fluid" alt="${board.title}">
								</c:if>	
								...
								<div class="portfolio-info">
									...
									<div class="portfolio-links">
										<a href="assets/img/portfolio/movie_image-2.jpg"
											...
											class="bx bx-plus"></i></a> <a href="detail"
